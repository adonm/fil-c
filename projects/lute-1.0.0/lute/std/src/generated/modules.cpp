...
// Instead, you should modify the source files in `/home/pizlo/Programs/fil-c/projects/lute-1.0.0/lute/std/libs`.
...
return table.freeze(iolib)
    ...
    {"@std/json.luau", R"MODULES_MOD(--!strict
-- @std/json
...
return table.freeze(queryLib)
    ...
    {"@std/syntax/types.luau", R"MODULES_MOD(local luau = require("@lute/luau")
