...
SSHCONF_INTFLAG(gss_keyex, GSSAPIKeyEx, SSHCFG_GLOBAL, 0, SSHCFG_COPY_MATCH) \
...
SSHCONF_INTFLAG(gss_store_rekey, GSSAPIStoreRekey, SSHCFG_GLOBAL, 0, SSHCFG_COPY_NONE) \
...
SSHCONF_UNSUPPORTED_INT(gss_keyex, GSSAPIKeyEx, SSHCFG_GLOBAL) \
...
SSHCONF_UNSUPPORTED_INT(gss_store_rekey, GSSAPIStoreRekey, SSHCFG_GLOBAL) \
